 ...
 */
     ...
     */
        ...
        public static function old($key = null, $default = null)
        {
                    ...
                    /**
         * Message the input for the current request to the session.
         *
         * @return void
         * @static
         */
        public static function flash()
        {
                    ...
                    /**
         * Message only some of the input to the session.
         *
     ...
     */
        ...
        public static function decrement($key, $amount = 1)
        {
                    ...
                    /**
         * Message a key / value pair to the session.
         *
         * @param string $key
         * @param mixed $value
         * @return void
        ...
        public static function flash($key, $value = true)
        {
                    ...
                    /**
         * Message a key / value pair to the session for immediate use.
         *
         * @param string $key
         * @param mixed $value
         * @return void
        ...
        public static function keep($keys = null)
        {
                    ...
                    /**
         * Message an input array to the session.
         *
         * @param array $value
         * @return void
         * @static
...
')
     ...
     */
         ...
         *
         *
         * @see \LaravelFrontendPresets\NowUiPreset\NowUiPresetServiceProvider::boot()
         * @param mixed $command
         * @static
         */
        public static function nowui($command)
        {
                        return \Illuminate\Console\Command::nowui($command);
        }
