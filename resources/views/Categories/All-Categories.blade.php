...
@section('content')
    <div class="panel-header">
        <div class="header text-center">
            ...
            <p class="category">نمایش تمامی دسته بندی های سایت
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a class="btn btn-success btn-round text-white pull-right h6" href="{{ Route('create-categorie') }}">
                            دسته جدید <i class="bi bi-file-earmark-plus"></i></a>
                        <h4 class="card-title">تمامی دسته ها</h4>
                            ...
                            <tbody>
                                @foreach ($all_categories as $categories)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $categories->creator_id }}</td>
