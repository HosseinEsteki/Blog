 ...
 * @typedef { import('resources/libraries/sweetalert2/sweetalert2').SweetAlertOptions } SweetAlertOptions
 * @typedef { import('resources/libraries/sweetalert2/sweetalert2').SweetAlertIcon } SweetAlertIcon
 * @typedef { import('resources/libraries/sweetalert2/sweetalert2').SweetAlertInput } SweetAlertInput
 * @typedef { import('resources/libraries/sweetalert2/sweetalert2').SweetAlertResult } SweetAlertResult
 * @typedef { import('resources/libraries/sweetalert2/sweetalert2').SweetAlertOptions['inputValue'] } SweetAlertInputValue
 */
