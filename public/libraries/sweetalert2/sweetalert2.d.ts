declare module 'resources/libraries/sweetalert2/sweetalert2' {
  /**
...
declare module 'sweetalert2/*/sweetalert2.js' {
  export * from 'resources/libraries/sweetalert2/sweetalert2'
  // "export *" does not matches the default export, so do it explicitly.
  export { default } from 'resources/libraries/sweetalert2/sweetalert2' // eslint-disable-line
}
